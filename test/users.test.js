  ...
  describe('/api/users', function () {
    describe('POST', function () {
      it('Should create a new user', function () {
        ...
        let res;
        return chai
          .request(app).post('/api/users').send(testUser)
          .then(_res => {
            res = _res;
      ...
      it('Should reject users with missing username', function () {
        ...
        return chai
          ...
          .send({testUser})
          .then(() =>
            expect.fail(null, null, 'Failed request')
          )
          .catch(err => {
      ...
      it('Should reject users with non-string fullname', function () {
        ...
        return chai
          ...
          .catch(err => {
            ...
            expect(res).to.have.status(422);
            expect(res.body.message).to.equal(
              'Field: \'fullname\' must be type String'
            );
          });
      });
      it('Should reject users with non-trimmed username', function () {
        const testUser = {username: '   boo', password, fullname};
        return chai
          .request(app)
          .post('/api/users')
          .send(testUser)
      ...
      it('Should reject users with non-trimmed password', function () {
        const testUser = {username, password: '   boo', fullname};
        return chai
          .request(app)
          .post('/api/users')
          .send(testUser)
      ...
      it('Should reject users with password greater than 72 characters', function () {
        let str = '7';
        const testUser = {username, password: str.repeat(80), fullname};
        return chai
          .request(app)
          .post('/api/users')
          .send(testUser)
      ...
      it('Should trim fullname', function () {
        const testUser = {username, password, fullname: '   bwahaha'};
        return chai
          .request(app)
          .post('/api/users')
          .send(testUser)
